...
public class PlayerListGUISection extends AbstractGUISection {
    ...
    public PlayerListGUISection(PlayersListGUIScreen screen) {
        super(screen);
        this.screen = screen;
    }
    ...
    public void init() {
        ...
        //Support
        for (AbstractContextAction action : OxygenGUIHelper.getContextActions(PlayersListMain.PLAYER_LIST_SCREEN_ID))
            menu.addElement(action);

        //Protection
        if (!OxygenGUIHelper.isNeedSync(PlayersListMain.PLAYER_LIST_SCREEN_ID) || OxygenGUIHelper.isDataRecieved(PlayersListMain.PLAYER_LIST_SCREEN_ID))
            this.sortPlayers(0);
        ...
        OxygenGUIHelper.screenInitialized(PlayersListMain.PLAYER_LIST_SCREEN_ID);
    }
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        ...
        if (element instanceof PlayerListEntryGUIButton) {
